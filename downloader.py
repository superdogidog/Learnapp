...
OUTPUT_DIR = "pinyin_audio"
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Base URL pattern
BASE_URL = "https://storage.yandexcloud.net/buyilehu/audio/pinyin/"

# Full official list of pinyin syllables (standard Mandarin)
# Source: complete list from Hanyu Pinyin standard GB/T 16159-2012
# You can add/remove if you want, but this covers everything.
pinyin_syllables = [
    "a","ai","an","ang","ao",
